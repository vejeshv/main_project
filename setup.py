...
if sys.argv[1] != "sdist":
    ...
    shutil.copyfile("knock-ack-daemon.py", "knockknock/knock-ack-daemon")
...
setup  (name         = 'knockknock',
        ...
        scripts      = ['knockknock/knockknock-daemon',
                        ...
                        'knockknock/knockknock','knockknock/knock-ack-daemon'],
        data_files   = [("", ["minimal-firewall.sh", "knockknock-daemon.py", 
                              "knockknock-genprofile.py", "knockknock-proxy.py", 
                              "knockknock.py","knock-ack-daemon.py","remove-firewall.sh"]),
...
try:
    ...
    os.remove("knockknock/knock-ack-daemon")

...
#listening for knock-ack
    command1 = ["knock-ack-daemon"]
    try: 
        subprocess.call(command1, shell=True, stderr=subprocess.STDOUT)

    except OSError:
	print "Error: knock-ack-daemon not installed."
	sys.exit(3)
#knock-ack end
